...
- **Review**:Today 到期队列 + 复习弹层(先回忆、后看答案),四档反馈(忘了 / 有点难 / 会了 / 轻松)自动排下一次复习,历史全程可查
- **复习曲线可自定义**:间隔阶梯默认 1→3→7→14→30 天,可在 **Settings → 复习曲线** 自由增删档位或一键套用预设(标准 / 密集 / 长期);保存后立即按新曲线重排所有未掌握题目的下次复习时间
